...
In order to provide you with a good picture of both stages of vinegar fermentation, we’ll begin with a recipe in which we first make alcohol through the fermentation of natural sugars, then ferment that alcohol into acetic acid with the help of AAB.
...
Our quick method of producing vinegar requires an air pump and air stone, which you can find at a home-brew shop or pet store. Read the recipe for full details.

We recommend that all your equipment be thoroughly cleaned and sanitized (seeCleanliness, Pathogens, and Safety).
...
The first stage of vinegar production is to use yeast to convert the sugar in fruit into alcohol. Find a bucket that will leave 15 percent of its volume after the pears are in. A 5-liter bucket is perfect here.
...
To speed things up and give us more control, we do two things. First, webackslop: Weigh the perry, then measure out 20% of that weight in unpasteurized pear vinegar (or a similar unpasteurized vinegar). For example, if you ended up with 1.8 kilograms perry, add 360 grams vinegar.
...
1. 1. Dice the pears and blend them into a coarse puree.

1. 2. Place the pear mash into a fermentation vessel, add the yeast, and cover with a lid and an airlock.

1. 3. Allow the mixture to ferment for 7 to 10 days.

1. 4. Press the mash to harvest the perry.

1. 5. Transfer the perry to a new vessel, backslop with unpasteurized vinegar, and set up an air stone and pump.

1. 6. Ferment until sufficiently soured, 10 to 14 days. Strain and bottle the finished vinegar, and store in the refrigerator.
...
### For More Accurate Sweetness, Use a Refractometer

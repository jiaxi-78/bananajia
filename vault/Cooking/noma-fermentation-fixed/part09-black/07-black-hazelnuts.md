...
The in-depth instructions forBlack Garlicserve as a template for all the blackened fruit and vegetable recipes in this chapter. We recommend you read that recipe before starting in on this one.
...
Either way, the sharp tips of the hazelnuts can potentially puncture the bag once placed in the fermentation chamber, so it’s a good idea to double-bag them.

Place the hazelnuts in the fermentation chamber. If you’re using an electric rice cooker or slow cooker, remember to raise the chestnuts off the bottom with a plate, wire rack, or bamboo mat. Close the chamber and set it to 60°C/140°F, or seal the cooker and turn it to the “keep warm” setting.
